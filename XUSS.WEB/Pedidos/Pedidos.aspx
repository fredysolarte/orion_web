<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterAdmin.Master" AutoEventWireup="true"
    CodeBehind="Pedidos.aspx.cs" Inherits="XUSS.WEB.Pedidos.Pedidos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <telerik:RadAjaxPanel ID="RadAjaxPanel2" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" ClientEvents-OnRequestStart="conditionalPostback"  ClientEvents-OnResponseEnd="endPostback">
                ...
                <asp:Panel ID="pnItemMaster" runat="server">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>                                
                                <asp:LinkButton ID="lnk_terceros" CommandName="Cancel" CausesValidation="true" runat="server" Text='<%# Eval("TRCODNIT") %>' OnClick="lnk_terceros_Click" />
                        ...
                        <tr>
                            ...
                            <td>
                                <%--<telerik:RadNumericTextBox ID="txt_tasa" runat="server" Enabled="false" DbValue='<%# Bind("PHTRMLOC") %>' Width="300px">
                                </telerik:RadNumericTextBox>                               --%>
                                <telerik:RadDatePicker ID="edt_fecliquidacion" runat="server" DbSelectedDate='<%# Bind("PHFECLIQ") %>'
                                    MinDate="01/01/1900" Enabled="false">
                                </telerik:RadDatePicker>
                                <asp:LinkButton id="lnk_tasa" CommandName="Cancel" CausesValidation="true" runat="server" Text="Ver Tasa" OnClick="lnk_tasa_Click"/>
                            </td>
                        </tr>
                    </table>
                    <asp:Panel ID="pnDetalle" runat="server">                           
                        <telerik:RadTabStrip ID="tb_pesatanas" runat="server" MultiPageID="RadMultiPage1"
                            ...
                            <Tabs>
                                <telerik:RadTab Text="Detalle Pedido">
                                </telerik:RadTab>
                        ...
                        <telerik:RadMultiPage ID="RadMultiPage1" runat="server" SelectedIndex="0">
                            <telerik:RadPageView ID="pv_pedido" runat="server">
                                <telerik:RadGrid ID="rg_items" runat="server" GridLines="None" Width="100%" AutoGenerateColumns="False" OnItemCommand="rg_items_OnItemCommand"
                                    ...
                                    <MasterTableView ShowGroupFooter="true">
                                        <ColumnGroups>
                                            <telerik:GridColumnGroup Name="lc_moneda" HeaderText="Moneda Default" HeaderStyle-HorizontalAlign="Center" />
                                            <telerik:GridColumnGroup Name="1" HeaderText="Moneda 1" HeaderStyle-HorizontalAlign="Center" />
                                            <telerik:GridColumnGroup Name="2" HeaderText="Moneda 2" HeaderStyle-HorizontalAlign="Center" />
                                            <telerik:GridColumnGroup Name="3" HeaderText="Moneda 3" HeaderStyle-HorizontalAlign="Center" />
                                            <telerik:GridColumnGroup Name="4" HeaderText="Moneda 4" HeaderStyle-HorizontalAlign="Center" />
                                            <telerik:GridColumnGroup Name="5" HeaderText="Moneda 5" HeaderStyle-HorizontalAlign="Center" />
                                            <telerik:GridColumnGroup Name="6" HeaderText="Moneda 6" HeaderStyle-HorizontalAlign="Center" />
                                        </ColumnGroups>
                                        <Columns>
                                            ...
                                            <telerik:GridTemplateColumn DataField="PDCLAVE1" HeaderText="Referencia" UniqueName="PDCLAVE1_TK"
                                                HeaderStyle-Width="130px" AllowFiltering="false" SortExpression="P_RCLAVE1" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl_referencia" runat="server" Text='<%# Eval("PDCLAVE1") %>' Visible="false"></asp:Label>
                                                </ItemTemplate>
                                            </telerik:GridTemplateColumn>
                                            <telerik:GridButtonColumn CommandName="link" UniqueName="PDCLAVE1" DataTextField="PDCLAVE1"
                                            ...
                                            <telerik:GridTemplateColumn DataField="PDBODEGA" HeaderText="Bodega" HeaderStyle-Width="190px"
                                                Resizable="true" SortExpression="PDBODEGA" UniqueName="PDBODEGA">
                                                <ItemTemplate>
                                                    <telerik:RadComboBox ID="rc_bodegadt" runat="server" Culture="es-CO" Width="190px" OnSelectedIndexChanged="rc_bodegadt_SelectedIndexChanged" AutoPostBack="true"
                                                        Enabled="false" DataSourceID="obj_bodega" DataTextField="BDNOMBRE" SelectedValue='<%# Bind("PDBODEGA") %>'
                                                        DataValueField="BDBODEGA" AppendDataBoundItems="true">
                                                        <Items>
                                                            <telerik:RadComboBoxItem Text="Seleccionar" Value="-1" />
                                                        </Items>
                                            ...
                                            <telerik:GridBoundColumn DataField="PDPRELIS" HeaderButtonType="TextButton" HeaderStyle-Width="80px" DataFormatString="{0:C}"
                                                ...
                                                UniqueName="PDPRELIS" ColumnGroupName="lc_moneda">
                                                <ItemStyle HorizontalAlign="Right" />
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="PDPRECIO" HeaderButtonType="TextButton" HeaderStyle-Width="80px" DataFormatString="{0:C}"
                                                ...
                                                UniqueName="PDPRECIO" ColumnGroupName="lc_moneda">
                                                <ItemStyle HorizontalAlign="Right" />
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="PDSUBTOT" HeaderButtonType="TextButton" HeaderStyle-Width="100px" DataFormatString="{0:C}"
                                                ...
                                                UniqueName="PDSUBTOT" Aggregate="Sum" ColumnGroupName="lc_moneda">
                                                <ItemStyle HorizontalAlign="Right" />
                                            </telerik:GridBoundColumn>
                            ...
                            <telerik:RadPageView ID="pv_evidencia" runat="server">
                                <telerik:RadGrid ID="rgSoportes" runat="server" GridLines="None" Width="100%" AutoGenerateColumns="False" UniqueID="rgSoportes"
                                    ...
                                    <MasterTableView>
                                        ...
                                        <Columns>
                                            <telerik:GridBoundColumn DataField="EP_CODIGO" HeaderButtonType="TextButton"
                                                HeaderStyle-Width="40px" HeaderText="" ItemStyle-HorizontalAlign="Right" Resizable="true"
                                                SortExpression="EP_CODIGO" UniqueName="EP_CODIGO" Visible="true">
                                                <ItemStyle HorizontalAlign="Right" />
                                            </telerik:GridBoundColumn>                                           
                ...
                <asp:Panel ID="pnItemMaster" runat="server">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <telerik:RadComboBox ID="rc_lstprecio" runat="server" Culture="es-CO" Width="300px" OnSelectedIndexChanged="rc_lstprecio_SelectedIndexChanged" AutoPostBack="true"
                        ...
                        <tr>
                           ...
                           <%-- <td>
                            ...
                            <td>
                                <telerik:RadNumericTextBox ID="txt_tasa" runat="server" Enabled="true" ValidationGroup="gvInsert" DbValue='<%# Bind("PHTRMLOC") %>' Width="300px">
                                </telerik:RadNumericTextBox>                               
                            </td>--%>
                            <td>
                                <label>Tasa</label>
                            ...
                            <td>
                              <%--  <telerik:RadNumericTextBox ID="txt_tasa" runat="server" Enabled="true" ValidationGroup="gvInsert" DbValue='<%# Bind("PHTRMLOC") %>' Width="300px">
                                ...
                                <telerik:RadDatePicker ID="edt_fecliquidacion" runat="server" DbSelectedDate='<%# Bind("PHFECLIQ") %>' AutoPostBack="true" OnSelectedDateChanged="edt_fecliquidacion_SelectedDateChanged"
                                    MinDate="01/01/1900" Enabled="true">
                                </telerik:RadDatePicker>                                
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" ControlToValidate="edt_fecliquidacion" 
                                    ErrorMessage="(*)" ValidationGroup="gvInsert">
                                    <asp:Image ID="Image12" runat="server" ImageUrl="~/App_Themes/Tema2/Images/Cancel.gif" /></asp:RequiredFieldValidator>
                                <asp:LinkButton id="lnk_tasa" CommandName="Cancel" CausesValidation="true" runat="server" Text="Ver Tasa" OnClick="lnk_tasa_Click"/>
                            </td>
                            ...
                            <MasterTableView ShowGroupFooter="true" InsertItemDisplay="Top" CommandItemDisplay="Top" DataKeyNames="PDLINNUM">
                                ...
                                <Columns>                                    
                                    ...
                                    <telerik:GridTemplateColumn DataField="PDBODEGA" HeaderText="Bodega" HeaderStyle-Width="190px"
                                        ...
                                        <ItemTemplate>
                                            <telerik:RadComboBox ID="rc_bodegadt" runat="server" Culture="es-CO" Width="190px" OnSelectedIndexChanged="rc_bodegadt_SelectedIndexChanged" AutoPostBack="true"
                                                Enabled="true" DataSourceID="obj_bodega" DataTextField="BDNOMBRE" SelectedValue='<%# Bind("PDBODEGA") %>'
                                                DataValueField="BDBODEGA" AppendDataBoundItems="true">
                                                <%--<Items>
                                                    <telerik:RadComboBoxItem Text="Seleccionar" Value="-1" />
                                                </Items>--%>
                                    ...
                                    <telerik:GridTemplateColumn DataField="PDPRECIO" HeaderText="PVP" HeaderStyle-Width="90px" Visible="false"
                                        Resizable="true" SortExpression="PDPRECIO" UniqueName="PDPRECIO"  ColumnGroupName="lc_moneda">
                                        <ItemTemplate>
                                            <telerik:RadNumericTextBox ID="txt_precio" runat="server" Enabled="false" DbValue='<%# Bind("PDPRECIO") %>' MinValue="0" Value="0" Width="90px" Visible="false">
                                            </telerik:RadNumericTextBox>
                                        </ItemTemplate>
                ...
                <asp:Panel ID="pnItemMaster" runat="server">
                    <table>
                        ...
                        <tr>
                            <td><label>T Pedido</label></td>
                            <td>
                                <telerik:RadComboBox ID="rc_tpedido" runat="server" Culture="es-CO" Width="300px" ValidationGroup="gvInsert"
                                    Enabled="false" DataSourceID="obj_tpedido" DataTextField="PTNOMBRE" SelectedValue='<%# Bind("PHTIPPED") %>'
                                    DataValueField="PTTIPPED" AppendDataBoundItems="true">
                                    <Items>
                                        <telerik:RadComboBoxItem Text="Seleccionar" Value="-1" />
                            ...
                            <td>
                                <telerik:RadComboBox ID="rc_bodega" runat="server" Culture="es-CO" Width="300px" ValidationGroup="gvInsert"
                                    Enabled="false" DataSourceID="obj_bodegaxusuario" DataTextField="BDNOMBRE" SelectedValue='<%# Bind("PHBODEGA") %>'
                                    DataValueField="BDBODEGA" AppendDataBoundItems="true">
                                    <Items>
                                        <telerik:RadComboBoxItem Text="Seleccionar" Value="-1" />
                                    </Items>
                        ...
                        <tr>
                            ...
                            <td>
                                <telerik:RadComboBox ID="rc_lstprecio" runat="server" Culture="es-CO" Width="300px" OnSelectedIndexChanged="rc_lstprecio_SelectedIndexChanged"
                                    Enabled="true" DataSourceID="obj_lstprecio" DataTextField="P_CNOMBRE" SelectedValue='<%# Bind("PHLISPRE") %>' AutoPostBack="true"
                                    DataValueField="P_CLISPRE" AppendDataBoundItems="true">
                                    <Items>
                                        <telerik:RadComboBoxItem Text="Seleccionar" Value="-1" />
                                    </Items>
                                </telerik:RadComboBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="rc_lstprecio" InitialValue="Seleccionar"
                                    ErrorMessage="(*)" ValidationGroup="gvInsert">
                        ...
                        <tr>
                            <td>
                                <%--<asp:ImageButton ID="ibtnLiquidar" runat="server" OnClick="ibtnLiquidar_OnClick" SkinID="SkinLiquidar" CommandName="xxx" />--%>
                            </td>
                        </tr>
                    </table>
                    <asp:Panel ID="pnDetalle" runat="server" Width="100%">                        
                        <telerik:RadGrid ID="rg_items" runat="server" GridLines="None" Width="100%" AutoGenerateColumns="False" OnDeleteCommand ="rg_items_OnDeleteCommand" OnPreRender="rg_items_PreRender"
                            Culture="(Default)" CellSpacing="0" ShowFooter="True" OnNeedDataSource="rg_items_OnNeedDataSource" OnItemCommand="rg_items_OnItemCommand">
                            <ClientSettings>
                            ...
                            <MasterTableView ShowGroupFooter="true" InsertItemDisplay="Top" CommandItemDisplay="Top" DataKeyNames="PDLINNUM">
                                ...
                                <CommandItemTemplate>                                    
                                    <telerik:RadButton RenderMode="Lightweight" ID="btn_agregar_item" runat="server" Text="Nuevo Item" Icon-PrimaryIconCssClass="rbAdd" CommandName="InitInsert" ToolTip="Nuevo Registro"  />
                                    <telerik:RadButton RenderMode="Lightweight" ID="btn_liquidar" runat="server" Text="Liquidar Pedido" Icon-PrimaryIconCssClass="rbCart" CommandName="Liquidar" ToolTip="Liqudiar Pedido" ValidationGroup="gvInsert"  />
                                    <telerik:RadButton RenderMode="Lightweight" ID="btn_tester" runat="server" Text="Tester" Icon-PrimaryIconCssClass="rbDownload" CommandName="Tester" ToolTip="Adicionar Tester"  />
                                </CommandItemTemplate>
                                <ColumnGroups>
                                    <telerik:GridColumnGroup Name="lc_moneda" HeaderText="Moneda Default" HeaderStyle-HorizontalAlign="Center" />                                                                        
                                    <telerik:GridColumnGroup Name="1" HeaderText="Moneda 1" HeaderStyle-HorizontalAlign="Center" />                                                                        
                                ...
                                <Columns>     
                                    ...
                                    <telerik:GridButtonColumn ConfirmText="Desea Quita Este Item?" ConfirmDialogType="RadWindow" ConfirmTitle="Delete" 
                                    ButtonType="ImageButton" CommandName="Delete"  HeaderStyle-Width="20px" />                               
                                    <telerik:GridBoundColumn DataField="PDLINNUM" HeaderButtonType="TextButton" HeaderStyle-Width="40px"
                                        HeaderText="Item" ItemStyle-HorizontalAlign="Right" Resizable="true" SortExpression="PDLINNUM"
                                        UniqueName="PDLINNUM" >
                                        <ItemStyle HorizontalAlign="Right" />
                                    </telerik:GridBoundColumn>
                                    ...
                                    <telerik:GridTemplateColumn DataField="PDDESCUE" HeaderText="Dcto" HeaderStyle-Width="70px"
                                    Resizable="true" SortExpression="PDDESCUE" UniqueName="PDDESCUE">
                                    <ItemTemplate>
                                        <telerik:RadNumericTextBox ID="txt_valor" runat="server" Enabled="true" DbValue='<%# Bind("PDDESCUE") %>' OnTextChanged="txt_valor_OnTextChanged"
                                            MinValue="0" Value="0" Width="60px" AutoPostBack="true" MaxValue="100">
                                        </telerik:RadNumericTextBox>
                                    </ItemTemplate>
                                    </telerik:GridTemplateColumn>   
                                    <telerik:GridTemplateColumn DataField="PDLISPRE" HeaderText="Lst Precios" HeaderStyle-Width="300px"
                                        Resizable="true" SortExpression="PDLISPRE" UniqueName="PDLISPRE">
                                        <ItemTemplate>
                                            <telerik:RadComboBox ID="rc_lstpreciodet" runat="server" Culture="es-CO" Width="280px" OnSelectedIndexChanged="rc_lstpreciodet_SelectedIndexChanged" AutoPostBack="true"
                                                Enabled="true" DataSourceID="obj_lstprecio" DataTextField="P_CNOMBRE" SelectedValue='<%# Bind("PDLISPRE") %>'
                                                DataValueField="P_CLISPRE" AppendDataBoundItems="true">
                                                <Items>
                                                    <telerik:RadComboBoxItem Text="Seleccionar" Value="-1" />
                                                </Items>
                                    ...
                                    <telerik:GridBoundColumn DataField="PDPRELIS" HeaderButtonType="TextButton" HeaderStyle-Width="120px" DataFormatString="{0:C}"
                                        HeaderText="P Lista" ItemStyle-HorizontalAlign="Right" Resizable="true" SortExpression="PDPRELIS"
                                        UniqueName="PDPRELIS" ColumnGroupName="lc_moneda" >                                        
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn DataField="PDPRECIO" HeaderButtonType="TextButton" HeaderStyle-Width="120px" DataFormatString="{0:C}"
                                        HeaderText="P Vta" ItemStyle-HorizontalAlign="Right" Resizable="true" SortExpression="PDPRECIO"
                                        UniqueName="PDPRECIO" ColumnGroupName="lc_moneda">                                        
                                    </telerik:GridBoundColumn>                                                          
                                    <telerik:GridBoundColumn DataField="PDSUBTOT" HeaderButtonType="TextButton" HeaderStyle-Width="140px" DataFormatString="{0:C}"
                                        HeaderText="Sub Total" ItemStyle-HorizontalAlign="Right" Resizable="true" SortExpression="PDSUBTOT"
                                        UniqueName="PDSUBTOT" Aggregate="Sum" ColumnGroupName="lc_moneda">                                        
                                    </telerik:GridBoundColumn>                                                                            
                                    <telerik:GridTemplateColumn DataField="PDPRECIO" HeaderText="PVP" HeaderStyle-Width="90px" Visible="false"
                                        ...
                                        <div>
                                            <table>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <telerik:RadTextBox ID="txt_referencia" runat="server" Enabled="false" Visible="true" ValidationGroup="grNuevo">
                                                        </telerik:RadTextBox>
                                                        ...
                                                        <asp:Image ID="Image25" runat="server" ImageUrl="~/App_Themes/Tema2/Images/Cancel.gif" /></asp:RequiredFieldValidator>
                                                    </td>
                                                    <td>
                                                        <label>
                                                            Producto</label>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txt_cantidad"
                                                        ErrorMessage="(*)" ValidationGroup="grNuevo" >
                                                        ...
                                                        <telerik:RadGrid ID="rgConsultaArticulos" runat="server" Width="100%"
                                                            ...
                                                            <MasterTableView>
                                                                <Columns>
                                                                    ...
                                                                    <telerik:GridBoundColumn Resizable="true" SortExpression="BDNOMBRE" HeaderText="Bodega"
                                                                        UniqueName="BDNOMBRE" HeaderButtonType="TextButton" DataField="BDNOMBRE" ItemStyle-HorizontalAlign="Right"
                                                                        HeaderStyle-Width="100px">
                                                                    </telerik:GridBoundColumn>
        ...
        <telerik:RadWindowManager RenderMode="Lightweight" ID="RadWindowManager1" runat="server" EnableShadow="true" Style="z-index: 7001;" >
            ...
            <Windows>
                ...
                <telerik:RadWindow RenderMode="Lightweight" ID="modalFiltroArt" runat="server" Width="1200px" Height="550px" Modal="true" OffsetElementID="main" Style="z-index: 1900;" Title="Buscar Productos">
                    <ContentTemplate>
                            ...
                            <telerik:RadGrid ID="rgConsultaArticulos" runat="server" Width="100%"
                                ...
                                <MasterTableView>
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn Resizable="true" SortExpression="TANOMBRE" HeaderText="Marca"
                                        ...
                                        <telerik:GridTemplateColumn DataField="BDBODEGA" HeaderText="" HeaderStyle-Width="80px" Visible="false"
                                            Resizable="true" SortExpression="BDBODEGA" UniqueName="BDBODEGA">
                                            <ItemTemplate>
                                                <telerik:RadTextBox ID="txt_fbodega" runat="server" Visible="false" Text='<%# Bind("BDBODEGA") %>' BorderStyle="None"
                                                    MinValue="0" Value="0" Width="77px">
                                                </telerik:RadTextBox>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                                        ...
                                        <telerik:GridBoundColumn Resizable="true" SortExpression="ARDTTEC1" HeaderText="Tamano"
                                            UniqueName="ARDTTEC1" HeaderButtonType="TextButton" DataField="ARDTTEC1" ItemStyle-HorizontalAlign="Right"
                                            HeaderStyle-Width="100px">
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn Resizable="true" SortExpression="ARDTTEC3" HeaderText="Tipo"
                                            UniqueName="ARDTTEC3" HeaderButtonType="TextButton" DataField="ARDTTEC3" ItemStyle-HorizontalAlign="Right"
                                            HeaderStyle-Width="100px">
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn Resizable="true" SortExpression="ARDTTEC4" HeaderText="Producto"
                                            UniqueName="ARDTTEC4" HeaderButtonType="TextButton" DataField="ARDTTEC4" ItemStyle-HorizontalAlign="Right"
                                            HeaderStyle-Width="100px">
                                        </telerik:GridBoundColumn>                                        
                                        <telerik:GridBoundColumn Resizable="true" SortExpression="BDNOMBRE" HeaderText="Bodega"
                        ...
                        <asp:Panel ID="pnl_agregar" runat="server" DefaultButton="btn_agregar">
                            <table>
                                ...
                                <tr>
                                    <td><label>Bodega</label></td>
                                    <td colspan="3">
                                        <telerik:RadComboBox ID="rc_fbodega" runat="server" Culture="es-CO" Width="300px" ValidationGroup="gvInsert"
                                            Enabled="false" DataSourceID="obj_bodegaxusuario" DataTextField="BDNOMBRE" 
                                            DataValueField="BDBODEGA" AppendDataBoundItems="true">
                                            <Items>
                                                <telerik:RadComboBoxItem Text="Seleccionar" Value="-1" />
                                            </Items>
                                        </telerik:RadComboBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="rc_fbodega" InitialValue="Seleccionar"
                                            ErrorMessage="(*)" ValidationGroup="grNuevoI">
                            ...
                            <tr>
                                <td>
                                    <asp:RadioButtonList ID="rbl_tiparch" runat="server" RepeatDirection="Horizontal" >
                                        <asp:ListItem Selected="True">Referencia + C2 + C3 + C4 + QTY +BD</asp:ListItem>
    ...
    <asp:ObjectDataSource ID="obj_pedidos" runat="server" OldValuesParameterFormatString="original_{0}" OnInserting="obj_pedidos_OnInserting" OnUpdating="obj_pedidos_OnUpdating"
        SelectMethod="GetPedidos" TypeName="XUSS.BLL.Pedidos.PedidosBL" OnInserted="obj_pedidos_OnInserted" InsertMethod="InsertPedidoHD" UpdateMethod="UpdatePedidoHD" >
        <SelectParameters>
        ...
        <InsertParameters>
            ...
            <asp:Parameter Name="PHFECLIQ" Type="DateTime" />            
        ...
        <UpdateParameters>
            ...
            <asp:Parameter Name="PHIDIOMA" Type="String" />
            <asp:Parameter Name="PHMONEDA" Type="String" /> 
            <asp:Parameter Name="PHTRMLOC" Type="Double" DefaultValue="0" />  
            <asp:Parameter Name="PHBODEGA" Type="String" />                 
            <asp:Parameter Name="PHLISPRE" Type="String" />
            <asp:SessionParameter Name="PHNMUSER" Type="String" SessionField="UserLogon" />   
            <asp:Parameter Name="PHOBSERV" Type="String" />
