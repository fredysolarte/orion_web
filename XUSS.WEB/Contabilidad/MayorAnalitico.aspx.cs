...
{
    public partial class MayorAnalitico : System.Web.UI.Page
    {
        ...
        protected void btn_filtro_Click(object sender, EventArgs e)
        {
            try
            {
                string url = ComunBL.GetHttpHttps(HttpContext.Current.Request.Url.AbsoluteUri) + "//" + HttpContext.Current.Request.Url.Authority + "/Reportes/VisorPantallaCompleta.aspx?rpt=9013&inban=S&inParametro=InMes&inValor=" + rc_mes.SelectedValue + "&inParametro=InAno&inValor=" + rc_ano.SelectedValue;
