<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterAdmin.Master" AutoEventWireup="true" CodeBehind="Separados.aspx.cs" Inherits="XUSS.WEB.Facturacion.Separados" %>
    ...
    <telerik:RadAjaxPanel ID="RadAjaxPanel2" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
        ...
        <telerik:RadListView ID="rlv_factura" runat="server" PageSize="1" AllowPaging="True" OnItemInserting="rlv_factura_OnItemInserting"
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <asp:LinkButton id="lnk_devolucion" CommandName="Cancel" CausesValidation="true" runat="server" Text="xxx" OnClick="lnk_devolucion_Click" Visible="false"/>                                            
                                        </td>
                                    </tr>
                                </table>
                            </td>
         ...
         <telerik:RadWindowManager RenderMode="Lightweight" ID="RadWindowManager1" runat="server" EnableShadow="true" Style="z-index: 7001;" >
            ...
            <Windows>
                <telerik:RadWindow RenderMode="Lightweight" ID="modalPopup" runat="server" Width="900px" Height="320px" Modal="true" OffsetElementID="main"  Title="Detalle" OnClientClose="modalPopup_OnClientClose" OnClientCommand="modalPopup_OnClientCommand" EnableShadow="true">                    
                    <ContentTemplate>
                        <table>
                            <tr>
                                <td>Cod Barras</td>
