<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterAdmin.Master" AutoEventWireup="true" CodeBehind="FacturacionSegmentos.aspx.cs" Inherits="XUSS.WEB.Facturacion.FacturacionSegmentos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <telerik:RadAjaxPanel ID="RadAjaxPanel2" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
        ...
        <telerik:RadListView ID="rlv_factura" runat="server" PageSize="1" AllowPaging="True" OnItemInserting="rlv_factura_OnItemInserting" OnPreRender="rlv_factura_PreRender"
                ...
                <fieldset class="cssFieldSetContainer">
                    <asp:Panel ID="pnVacio" runat="server" DefaultButton="btn_filtro">
                        ...
                        <table>
                            ...
                            <tr>
                                <td>
                                    <telerik:RadButton ID="btn_filtro" runat="server" OnClick="btn_filtro_OnClick" Text="Buscar" RenderMode="Lightweight">
                                    </telerik:RadButton>
                                </td>
                            </tr>
                        </table>
                            ...
                            <td colspan="2">
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <telerik:RadTextBox ID="txt_tiprem" runat="server" Enabled="false" Text='<%# Bind("HD_TIPREM") %>' Width="30px">
                                            </telerik:RadTextBox>
                                            <telerik:RadTextBox ID="txt_nrorem" runat="server" Enabled="false" Text='<%# Bind("HD_NROREM") %>' Width="80px">
                                            </telerik:RadTextBox>
                                            <telerik:RadButton RenderMode="Lightweight" ID="btn_buscarrem" OnClick="btn_buscarrem_Click" runat="server" Icon-PrimaryIconCssClass="rbSearch" ToolTip="Buscar Lta Empaque" />
                                        </td>
                                    </tr>
                                </table>
                            </td>
        ...
        <telerik:RadWindowManager RenderMode="Lightweight" ID="RadWindowManager1" runat="server" EnableShadow="true" Style="z-index: 7001;">
            ...
            <Windows>
                        ...
                        <div style="padding: 5px 5px 5px 5px">
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <telerik:RadButton ID="btn_filtroLtsEmpaque" runat="server" Text="Filtrar" OnClick="btn_filtroLtsEmpaque_OnClick" RenderMode="Lightweight"  Icon-PrimaryIconCssClass="rbSearch"
                                            CommandName="Cancel" />
                                    </td>
                                </tr>
                            </table>
                ...
                <telerik:RadWindow RenderMode="Lightweight" ID="mpRemisiones" runat="server" Width="820px" Height="350px" Modal="true" OffsetElementID="main" Style="z-index: 100001;" Title="Buscar Remision">
                    <ContentTemplate>
                        <div style="padding: 5px 5px 5px 5px">
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <telerik:RadTextBox ID="txt_nrorem" runat="server" Enabled="true" Width="150px">
                                        </telerik:RadTextBox>
                                    </td>
                                    <td>
                                        <label>Tercero</label></td>
                                    <td>
                                        <telerik:RadTextBox ID="txt_nomrem" runat="server" Enabled="true" Width="150px">
                                        </telerik:RadTextBox>
                                    </td>
                                    <td>
                                        <telerik:RadButton ID="btn_filtrorem" runat="server" Text="Filtrar" OnClick="btn_filtrorem_Click" RenderMode="Lightweight" Icon-PrimaryIconCssClass="rbSearch"
                                            CommandName="Cancel" />
                                    </td>
                                </tr>
                            </table>
                            <asp:Panel ID="Panel2" runat="server">
                                <telerik:RadGrid ID="rg_remision" runat="server" AllowSorting="True" Width="100%"
                                    AutoGenerateColumns="False" AllowPaging="True" PageSize="7" CellSpacing="0" GridLines="None"
                                    DataSourceID="obj_remision" OnItemCommand="rg_remision_ItemCommand">
                                    <MasterTableView>
                                        <Columns>
                                            <telerik:GridButtonColumn Text="Seleccionar" CommandName="Select">
                                                <HeaderStyle Width="40px" />
                                            </telerik:GridButtonColumn>
                                            <telerik:GridBoundColumn Resizable="true" SortExpression="HDTIPFAC" HeaderText="Tip"
                                                UniqueName="HDTIPFAC" HeaderButtonType="TextButton" DataField="HDTIPFAC" ItemStyle-HorizontalAlign="Right"
                                                HeaderStyle-Width="30px">
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn Resizable="true" SortExpression="TFNOMBRE" HeaderText="T Documento"
                                                UniqueName="TFNOMBRE" HeaderButtonType="TextButton" DataField="TFNOMBRE" ItemStyle-HorizontalAlign="Right"
                                                HeaderStyle-Width="120px">
                                            </telerik:GridBoundColumn>                                            
                                            <telerik:GridBoundColumn Resizable="true" SortExpression="HDNROFAC" HeaderText="Nro Documento"
                                                UniqueName="HDNROFAC" HeaderButtonType="TextButton" DataField="HDNROFAC" ItemStyle-HorizontalAlign="Right"
                                                HeaderStyle-Width="120px">
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn Resizable="true" SortExpression="TRNOMBRE" HeaderText="Tercero"
                                                UniqueName="TRNOMBRE" HeaderButtonType="TextButton" DataField="TRNOMBRE" ItemStyle-HorizontalAlign="Right"
                                                HeaderStyle-Width="350px">
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="DTTOTFAC" HeaderButtonType="TextButton" HeaderStyle-Width="120px"
    ...
    <asp:ObjectDataSource ID="obj_remision" runat="server" OldValuesParameterFormatString="original_{0}" 
