<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterAdmin.Master" AutoEventWireup="true" CodeBehind="RemisionSegmento.aspx.cs" Inherits="XUSS.WEB.Facturacion.RemisionSegmento" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <telerik:RadAjaxPanel ID="RadAjaxPanel2" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
                    ...
                    <asp:Panel ID="pnVacio" runat="server" DefaultButton="btn_filtro">
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <telerik:RadTextBox ID="txt_pedido" runat="server" Enabled="true" Width="250px">
                                    </telerik:RadTextBox>
                                </td>
                            </tr>
                            <tr>
                ...
                <asp:Panel ID="pnItemMaster" runat="server" Width="100%">
                            ...
                            <td colspan="2">
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:LinkButton ID="lnk_remision" CommandName="Cancel" CausesValidation="true" runat="server" Text='<%# Eval("rms_lnk") %>' OnClick="lnk_remision_Click" />
                                        </td>--%>
                                    </tr>
                                </table>
                            </td>
                                            ...
                                            <td>
                                                <telerik:RadComboBox ID="rc_estado" runat="server" SelectedValue='<%# Bind("HDESTADO") %>'
                                                    ...
                                                    <Items>
                                                        ...
                                                        <telerik:RadComboBoxItem Text="C Factura" Value="CN" />
                                                    </Items>
                                                </telerik:RadComboBox>
                                            </td>
                                        </tr>
                    ...
                    <telerik:RadSplitter RenderMode="Lightweight" ID="RadSplitter1" runat="server" Width="100%" Height="380px">
                        <telerik:RadPane ID="LeftPane" runat="server" Width="70%">
                            <telerik:RadGrid ID="rg_items" runat="server" GridLines="None" Width="100%" AutoGenerateColumns="False" Height="100%" OnItemCommand="rg_items_OnItemCommand"
                                Culture="(Default)" CellSpacing="0" ShowFooter="True" OnDetailTableDataBind="rg_items_OnDetailTableDataBind">
                                <ClientSettings>
                                    <Scrolling AllowScroll="True" UseStaticHeaders="True"></Scrolling>
                                </ClientSettings>
                                <MasterTableView ShowGroupFooter="true" DataKeyNames="DTTIPFAC,DTNROFAC,DTNROITM">
                                    <DetailTables>
                                    ...
                                    <Columns>
                                        <telerik:GridBoundColumn DataField="DTNROITM" HeaderButtonType="TextButton" HeaderStyle-Width="40px"
                                        ...
                                        <telerik:GridTemplateColumn DataField="DTCLAVE1" HeaderText="Referencia" UniqueName="DTCLAVE1_TK"
                                        HeaderStyle-Width="130px" AllowFiltering="false" SortExpression="DTCLAVE1" Visible="false">
                                            <ItemTemplate>
                                                <asp:Label ID="lbl_referencia" runat="server" Text='<%# Eval("DTCLAVE1") %>' Visible="false"></asp:Label>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                                        <telerik:GridButtonColumn CommandName="link" UniqueName="DTCLAVE1" DataTextField="DTCLAVE1"
                            ...
                            <td colspan="2">
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <telerik:RadComboBox ID="rc_tipfac" runat="server" Culture="es-CO" OnSelectedIndexChanged="rc_tipfac_OnSelectedIndexChanged" AutoPostBack="true"
                                    ...
                                    <telerik:RadMultiPage ID="RadMultiPage1" runat="server" SelectedIndex="0">
                                        <telerik:RadPageView ID="pv_dtercero" runat="server">
                                            <table>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <telerik:RadTextBox ID="txt_apellido" runat="server" Enabled="true" Text='<%# Bind("TRAPELLI") %>'
                                                            Width="300px">
                                                        </telerik:RadTextBox>
                                                    </td>
                                                </tr>
                                        ...
                                        <telerik:RadPageView ID="pv_dcomerciales" runat="server">
                                            <table>
                                                ...
                                                <tr>
                                                    <td><label>T. Descuento</label></td>
                                                    <td>
                                                         <telerik:RadComboBox ID="rc_tdescuento" runat="server" Culture="es-CO" Width="300px"
                                                             Enabled="true" DataSourceID="obj_tdescuento" DataTextField="NOMBRE" 
                    ...
                    <telerik:RadSplitter RenderMode="Lightweight" ID="RadSplitter1" runat="server" Width="100%" Height="380px">
                        <telerik:RadPane ID="LeftPane" runat="server" Width="70%">
                            <telerik:RadGrid ID="rg_items" runat="server" GridLines="None" Width="100%" AutoGenerateColumns="False" OnItemCommand="rg_items_OnItemCommand" OnDeleteCommand="rg_items_OnDeleteCommand" Height="100%"
                                ...
                                <MasterTableView ShowGroupFooter="true" InsertItemDisplay="Top" CommandItemDisplay="Top" DataKeyNames="DTTIPFAC,DTNROFAC,DTNROITM">
                                    <CommandItemSettings AddNewRecordText="Nuevo Item" ShowRefreshButton="false" RefreshText="Cargar" />
                                    <CommandItemTemplate>                                    
                                            ...
                                            <telerik:RadButton RenderMode="Lightweight" ID="btn_agregar_archivo" runat="server" Text="Cargar Archivo" Icon-PrimaryIconCssClass="rbRefresh" CommandName="RebindGrid" ToolTip="Cargar Archivo"  />
                                        </CommandItemTemplate>
                                    <DetailTables>
        ...
        <telerik:RadWindowManager RenderMode="Lightweight" ID="RadWindowManager1" runat="server" EnableShadow="true" Style="z-index: 7001;" >
            ...
            <Windows>
                <telerik:RadWindow RenderMode="Lightweight" ID="modalPopup" runat="server" Width="900px" Height="360px" Modal="true" OffsetElementID="main"  Title="Detalle" OnClientClose="modalPopup_OnClientClose"  EnableShadow="true" Style="z-index: 100001;">                    
                    <ContentTemplate>
                        <table>
                            <tr>
                                <td>Cod Barras</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:CompareValidator runat="server" ID="cmpNumbers" ControlToValidate="txt_cantidad" ControlToCompare="txt_caninv" Operator="LessThanEqual" Type="Integer"
                                        ...
                                        <asp:Image ID="Image55" runat="server" ImageUrl="~/App_Themes/Tema2/Images/Cancel.gif" />
                ...
                <ContentTemplate>
                    ...
                    <div style="text-align: center;">
                        <telerik:RadButton RenderMode="Lightweight" ID="btn_acpetar_anular" runat="server" Text="Aceptar" OnClick="btn_acpetar_anular_OnClick" ValidationGroup="gvAnular" Icon-PrimaryIconCssClass="rbSave">
                        </telerik:RadButton>
                    </div>
                </ContentTemplate>
                </telerik:RadWindow>
                            ...
                            <tr>
                                ...
                                <td>
                                    <telerik:RadComboBox ID="rc_tpago" runat="server" Culture="es-CO" DataSourceID="obj_tpago" DataTextField="TTDESCRI"  ZIndex="1000000"
                                        DataValueField="TTCODCLA" AppendDataBoundItems="true" Width="300px" Filter="Contains" OnClientSelectedIndexChanged="rc_tpago_OnClientSelectedIndexChanged"  > <%--OnSelectedIndexChanged="rc_tpago_OnSelectedIndexChanged" AutoPostBack="true"--%>
                                        <Items>
                                            <telerik:RadComboBoxItem Text="Seleccionar" Value="" />
                                        </Items>
                                    </telerik:RadComboBox>
                ...
                <telerik:RadWindow RenderMode="Lightweight" ID="modalLstEmpaque" runat="server" Width="900px" Height="320px" Modal="true" OffsetElementID="main" Style="z-index: 100001;" Title="Buscar Lista Empaque">
                    <ContentTemplate>                        
                        <div style="padding: 5px 5px 5px 5px">
                            <table>
                                <tr>
                    ...
                    <ContentTemplate>
                        <table>
                            <tr>
                                ...
                                <td>
                                    <asp:Button ID="btn_filtro_fac_dev" runat="server" Text="Filtrar" 
                                    CommandName="Cancel" />
                                </td>
                            </tr>
                        </table>
                        ...
                        <table>
                            <tr>
                                <td>
                                    <asp:Button ID="btn_aceptar_facdev" runat="server" Text="Agregar" CommandName="Cancel" Icon-PrimaryIconCssClass="rbAdd" />
                    ...
                    <ContentTemplate>
                        <table>
                            <tr>
                                ...
                                <td>
                                    <asp:Button ID="btn_filtro_sep" runat="server" Text="Filtrar" 
                                    CommandName="Cancel" />
                                </td>
                            </tr>
                        </table>
                        ...
                        <table>
                            <tr>
                                <td>
                                    <asp:Button ID="btn_aceptar_sep" runat="server" Text="Agregar" CommandName="Cancel" Icon-PrimaryIconCssClass="rbAdd" />
                ...
                <telerik:RadWindow RenderMode="Lightweight" ID="modalTerceros" runat="server" Width="900px" Height="320px" Modal="true" OffsetElementID="main" Style="z-index: 100001;" Title="Terceros">
                    <ContentTemplate>
                        <table>
                        <tr>
                            <td>
                            ...
                            <td>
                                ...
                                <telerik:RadButton RenderMode="Lightweight" ID="btn_filtroTer" runat="server" Text="Filtrar" Icon-PrimaryIconCssClass="rbSearch" CommandName="Cancel" OnClick="btn_filtroTer_OnClick" />
                            </td>
                        </tr>
                    </table>
                        ...
                        <telerik:RadGrid ID="rgConsultaTerceros" runat="server" AllowSorting="True" Width="800px"
                            ...
                            <MasterTableView DataKeyNames="TRCODTER,TRCODNIT,TRNOMBRE,TRNOMBR2,TRAPELLI">
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn Resizable="true" SortExpression="TRAPELLI" HeaderText=""
                                        UniqueName="TRAPELLI" HeaderButtonType="TextButton" DataField="TRAPELLI" ItemStyle-HorizontalAlign="Right"
                                        HeaderStyle-Width="80px">
                                    </telerik:GridBoundColumn>                                 
                    ...
                    <ContentTemplate>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <telerik:RadButton RenderMode="Lightweight" ID="btn_filtroArticulos" runat="server" Text="Filtrar" Icon-PrimaryIconCssClass="rbSearch" CommandName="xxxxxx" OnClick="btn_filtroArticulos_OnClick" />
                            </td>
                        </tr>
                    </table>
    ...
    <asp:ObjectDataSource ID="obj_factura" runat="server" OldValuesParameterFormatString="original_{0}" InsertMethod="InsertFaturacionSegmento" OnInserted="obj_factura_OnInserted"
        ...
        <InsertParameters>            
            ...
            <asp:Parameter Name="HD_TIPREM" Type="String" />
            <asp:Parameter Name="HD_NROREM" Type="Int32" />
        </InsertParameters>
    ...
    <asp:ObjectDataSource ID="obj_tfxusuario" runat="server" OldValuesParameterFormatString="original_{0}"
        ...
        <SelectParameters>
            <asp:Parameter Name="connection" Type="String" />     
            <asp:Parameter DefaultValue="TFCLAFAC IN (5)" Name="filter" Type="String" />       
    ...
    <asp:ObjectDataSource ID="obj_tdescuento" runat="server" OldValuesParameterFormatString="original_{0}"
        ...
        <SelectParameters>
            <asp:Parameter Name="connection" Type="String" />            
            <asp:Parameter Name="filter" Type="String" DefaultValue=" CONDICION='Q' AND ESTADO='AC'" />
            <asp:Parameter Name="startRowIndex" Type="Int32" DefaultValue="" />
            <asp:Parameter Name="maximumRows" Type="Int32" DefaultValue="" />
        </SelectParameters>
    </asp:ObjectDataSource>
</asp:Content>