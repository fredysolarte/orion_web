<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterAdmin.Master" AutoEventWireup="true"
    CodeBehind="FacturacionPedido.aspx.cs" Inherits="XUSS.WEB.Facturacion.FacturacionPedido" %>
                        ...
                        <div style="padding: 5px 5px 5px 5px">
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <%--<asp:Button ID="btn_filtroLtsEmpaque" runat="server" Text="Filtrar" OnClick="btn_filtroLtsEmpaque_OnClick" CommandName="Cancel" />--%>
