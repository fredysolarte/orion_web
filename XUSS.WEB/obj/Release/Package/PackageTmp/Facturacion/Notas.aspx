<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterAdmin.Master" AutoEventWireup="true" CodeBehind="Notas.aspx.cs" Inherits="XUSS.WEB.Facturacion.Notas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadScriptBlock ID="rsbDownLoad" runat="server">
        ...
        <script type="text/javascript">    
            ...
            function chk_habilita_OnClick(obj) {
                //alert(obj.checked);
                debugger;
                //var eItem = $find('<%= rg_detalle.ClientID %>');
                //var control = $telerik.findElement(eItem.get_element().parentNode, "txt_valor");
                //var control1 = $telerik.findElement(eItem.get_element().parentNode, "txt_valornew");
                //control1.value = control.value;
                //control = $telerik.findElement(eItem.get_element().parentNode, "txt_iva");
                //control1 = $telerik.findElement(eItem.get_element().parentNode, "txt_ivanew");
                //control1.value = control.value;
                //control = $telerik.findElement(eItem.get_element().parentNode, "txt_total");
                //control1 = $telerik.findElement(eItem.get_element().parentNode, "txt_totalnew");
                //control1.value = control.value;
                ...
                for (var i = 0; i < row.length; i++) {
                    ...
                    if (chk.checked) {
                        ...
                        if (parseFloat(control1.value) == 0) {
                            //control = masterTable.get_dataItems()[i].findControl("txt_valor");
                            //control1 = masterTable.get_dataItems()[i].findControl("txt_valornew");
                            //control1.val(control.value);
                            ...
                            //var vl_1 = control.value.replace('.', '');
                            //ln_subtotal = parseFloat(ln_subtotal) + parseFloat($telerik.findControl(masterTable.get_element().parentNode, control._clientID).get_value());

                            //control = masterTable.get_dataItems()[i].findControl("txt_iva");
                            //control1 = masterTable.get_dataItems()[i].findControl("txt_ivanew");                            
                            //$telerik.findControl(masterTable.get_element().parentNode, control1._clientID).set_value($telerik.findControl(masterTable.get_element().parentNode, control._clientID).get_value());                            
                            //ln_iva = parseFloat(ln_iva) + parseFloat($telerik.findControl(masterTable.get_element().parentNode, control._clientID).get_value());

                            control = masterTable.get_dataItems()[i].findControl("txt_total");
                            control1 = masterTable.get_dataItems()[i].findControl("txt_totalnew");
                            $telerik.findControl(masterTable.get_element().parentNode, control1._clientID).set_value($telerik.findControl(masterTable.get_element().parentNode, control._clientID).get_value());
                            //ln_total = parseFloat(ln_total) + parseFloat($telerik.findControl(masterTable.get_element().parentNode, control._clientID).get_value());
                        }
                        ...
                        //masterTable.get_dataItems()[i].findElement("txt_valornew").value = 0;
                        //masterTable.get_dataItems()[i].findElement("txt_ivanew").value = 0;
                        //masterTable.get_dataItems()[i].findElement("txt_totalnew").value = 0;
                    }
                }
    ...
    <telerik:RadAjaxPanel ID="RadAjaxPanel2" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
        ...
        <telerik:RadListView ID="rlv_notas" runat="server" PageSize="1" OnItemInserted="rlv_notas_OnItemInserted" OnItemInserting="rlv_notas_OnItemInserting"
            ...
            DataSourceID="obj_notas" ItemPlaceholderID="pnlGeneral" DataKeyNames="NH_NRONOTA" DataSourceCount="0" ResolvedRenderMode="Classic">
            <LayoutTemplate>
                ...
                <asp:Panel ID="pnItemMaster" runat="server">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <label>Genera Inv</label>
                            </td>
                            <td>
                                <asp:CheckBox ID="chk_habilita" runat="server" Checked='<%# this.GetEstado(Eval("NH_INDINV")) %>' Enabled="false" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <telerik:RadGrid ID="rg_items" runat="server" GridLines="None" Width="100%" AutoGenerateColumns="False" OnItemCommand="rg_items_OnItemCommand" OnDeleteCommand="rg_items_OnDeleteCommand"
                            ...
                            <MasterTableView ShowGroupFooter="true" DataKeyNames="ND_NROITEM">
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn DataField="ND_CANTIDAD" HeaderButtonType="TextButton" HeaderStyle-Width="80px" DataFormatString="{0:0}"
                                        HeaderText="Cant" ItemStyle-HorizontalAlign="Right" Resizable="true" SortExpression="ND_CANTIDAD"
                                        UniqueName="ND_CANTIDAD" Aggregate="Sum">
                                        <ItemStyle HorizontalAlign="Right" />
                                    </telerik:GridBoundColumn>
                ...
                <asp:Panel ID="pnItemMaster" runat="server">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:CheckBox ID="chk_habilita" runat="server" Checked='<%# this.GetEstado(Eval("NH_INDINV")) %>' Enabled="true" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <label>Observaciones</label></td>
                            <td colspan="3">
                                <telerik:RadTextBox ID="txt_descripcion" runat="server" Enabled="true" Text='<%# Bind("NH_DESCRIPCION") %>' Width="500px" TextMode="MultiLine" Height="60px">
                                </telerik:RadTextBox>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <telerik:RadGrid ID="rg_items" runat="server" GridLines="None" Width="100%" AutoGenerateColumns="False" OnItemCommand="rg_items_OnItemCommand" OnDeleteCommand="rg_items_OnDeleteCommand"
                            ...
                            <MasterTableView ShowGroupFooter="true" InsertItemDisplay="Top" CommandItemDisplay="Top" DataKeyNames="ND_NROITEM">
                                ...
                                <Columns>
                                    ...
                                    <%--<telerik:GridBoundColumn DataField="ND_NROITEM" HeaderButtonType="TextButton" HeaderStyle-Width="20px"
                                        HeaderText="Item" ItemStyle-HorizontalAlign="Right" Resizable="true" SortExpression="ND_NROITEM"
                                        UniqueName="ND_NROITEM" >
                                        <ItemStyle HorizontalAlign="Right" />
                                    </telerik:GridBoundColumn>--%>
                                    <telerik:GridTemplateColumn DataField="DTTIPFAC" HeaderText="T. Doc" HeaderStyle-Width="150px" Visible="false"
                                        Resizable="true" SortExpression="DTTIPFAC" UniqueName="DTTIPFAC">
        ...
        <telerik:RadWindowManager RenderMode="Lightweight" ID="RadWindowManager1" runat="server" EnableShadow="true" Style="z-index: 7001;">
            ...
            <Windows>
                ...
                <telerik:RadWindow RenderMode="Lightweight" ID="modalTerceros" runat="server" Width="890px" Height="360px" Modal="true" OffsetElementID="main" Style="z-index: 100001;" Title="Terceros">
                    <ContentTemplate>
                        <table>
                            <tr>
                                <td>
                            ...
                            <telerik:RadGrid ID="rg_facturas" runat="server" AllowSorting="True" Width="98%" ShowFooter="True"
                                ...
                                <MasterTableView DataKeyNames="HDCODEMP,HDTIPFAC,HDNROFAC">
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn DataField="SC_NOMBRE" HeaderButtonType="TextButton" HeaderStyle-Width="150px"
                                            HeaderText="Sucursal" ItemStyle-HorizontalAlign="Right" Resizable="true" SortExpression="SC_NOMBRE"
                                            UniqueName="SC_NOMBRE" FilterControlWidth="100px">                                            
                                        </telerik:GridBoundColumn>                                        
                ...
                <telerik:RadWindow RenderMode="Lightweight" ID="modalDetalle" runat="server" Width="1100px" Height="590px" Modal="true" OffsetElementID="main" Style="z-index: 5999;" Title="Detalle Factura">
                    <ContentTemplate>
                        <asp:Panel ID="Panel2" runat="server">
                            <telerik:RadGrid ID="rg_detalle" runat="server" AllowSorting="True" Width="100%" ShowFooter="True" Height="450px" AllowFilteringByColumn="true"
                                ...
                                <MasterTableView>
                                    <Columns>
                                        ...
                                        <telerik:GridTemplateColumn DataField="ARNOMBRE" HeaderText="Articulo" HeaderStyle-Width="350px" Visible="true"
                                            Resizable="true" SortExpression="ARNOMBRE" UniqueName="ARNOMBRE">
                                            <ItemTemplate>
                                                <asp:Label ID="lbl_articulo" runat="server" Text='<%# Bind("ARNOMBRE") %>' Width="250px"></asp:Label>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                                        ...
                                        <telerik:GridTemplateColumn DataField="DTPRECIO" HeaderText="Precio" HeaderStyle-Width="80px" Visible="true"
                                            Resizable="true" SortExpression="DTPRECIO" UniqueName="DTPRECIO" AllowFiltering="false">
                                            <ItemTemplate>
                                                <telerik:RadNumericTextBox ID="txt_precio" runat="server" Enabled="false" DbValue='<%# Bind("DTPRECIO") %>'
                                                    MinValue="0" Value="0" Width="80px">
                                                </telerik:RadNumericTextBox>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                                        <telerik:GridTemplateColumn DataField="DTCANTID" HeaderText="Cant" HeaderStyle-Width="40px" Visible="true"
                                            Resizable="true" SortExpression="DTCANTID" UniqueName="DTCANTID" AllowFiltering="false">
                                            <ItemTemplate>
                                                <telerik:RadNumericTextBox ID="txt_cantidad" runat="server" Enabled="false" DbValue='<%# Bind("DTCANTID") %>'
                                                    MinValue="0" Value="0" Width="40px" NumberFormat-DecimalDigits="0" >
                                                </telerik:RadNumericTextBox>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                                        <telerik:GridTemplateColumn  HeaderText="Dev" HeaderStyle-Width="40px" Visible="true" AllowFiltering="false"
                                            Resizable="true" UniqueName="ND_CANTIDAD">
                                            <ItemTemplate>
                                                <telerik:RadNumericTextBox ID="txt_cantidaddev" runat="server" Enabled="true" 
                                                    MinValue="0" Value="0" Width="40px" NumberFormat-DecimalDigits="0">
                                                </telerik:RadNumericTextBox>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                        ...
                        <table width="100%">
                            <tr>
                                ...
                                <td>
                                    <asp:Label runat="server" ID="lbl_subtotal" Text="0" Width="150px"></asp:Label></td>
                                <td>
                                ...
                                <td>
                                    <asp:Label runat="server" ID="lbl_total" Text="0" Width="150px"></asp:Label></td>
                            </tr>
                            <tr>
                                <td align="left">
    ...
    <asp:ObjectDataSource ID="obj_notas" runat="server" OldValuesParameterFormatString="original_{0}" InsertMethod="InsertNota" OnInserted="obj_notas_OnInserted" OnInserting="obj_notas_OnInserting"
        SelectMethod="GetNotaHD" TypeName="XUSS.BLL.Facturacion.NotasBL">
        <SelectParameters>
        ...
        <InsertParameters>
            ...
            <asp:Parameter Name="NH_INDINV" Type="String" />            
    ...
    <asp:ObjectDataSource ID="obj_tipfac" runat="server" OldValuesParameterFormatString="original_{0}"
        ...
        <SelectParameters>
            <asp:Parameter Name="connection" Type="String" />
            <asp:Parameter DefaultValue="TFCLAFAC IN (8) AND TFESTADO='AC'" Name="filter" Type="String" />
            <asp:Parameter Name="startRowIndex" Type="Int32" />
            <asp:Parameter Name="maximumRows" Type="Int32" />
        </SelectParameters>
    </asp:ObjectDataSource>
