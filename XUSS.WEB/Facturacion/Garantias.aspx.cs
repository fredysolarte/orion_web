...
namespace XUSS.WEB.Facturacion
{
    public partial class Garantias : System.Web.UI.Page
    {
        ...
        private DataTable tbGarantia
        {
            set { ViewState["tbGarantia"] = value; }
            get { return ViewState["tbGarantia"] as DataTable; }
        }
        ...
        protected void rlv_factura_OnItemCommand(object sender, Telerik.Web.UI.RadListViewCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                case "InitInsert":
                    ...
                    GarantiasBL ObjG = new GarantiasBL();
                    try
                    {
                        tbItems = Obj.GetFacturaDT(null, null, null, 0);
                        tbGarantia = ObjG.GetGarantia(null, null, null, 0);
                    }
                    catch (Exception ex)
                    {
                        throw ex;
        ...
        protected void rlv_factura_OnItemDataBound(object sender, RadListViewItemEventArgs e)
        {
            ...
            try
            {
                ...
                tbGarantia = ObjG.GetGarantia(null, Convert.ToString(Session["CODEMP"]), Convert.ToString((e.Item.FindControl("rc_tipfac") as RadComboBox).SelectedValue), Convert.ToInt32((e.Item.FindControl("txt_nrofac") as RadTextBox).Text));
                (e.Item.FindControl("rg_pagos") as RadGrid).DataSource = tbGarantia;
        ...
        {
            (source as RadGrid).DataSource = tbGarantia;
        }
        ...
        {
            DataRow row = tbGarantia.NewRow();
            try
            {
                //row["PGCODEMP"] = Convert.ToString(Session["CODEMP"]);
                //row["PGTIPFAC"] = "";
                //row["PGNROFAC"] = 0;
                //row["PGNROITM"] = tbGarantia.Rows.Count + 1;
                ...
                row["GT_CONSECUTIVO"] = 0;
                row["GT_CODEMP"] = "001";
                row["GT_TIPFAC"] = "FT";
                row["GT_NROFAC"] = 0;
                row["GT_USUARIO"] = "ADMIN";
                row["GT_OBSERVACIONES"] = txt_observaciones.Text;
                row["GT_ESTADO"] = "AC";
                row["GT_FECING"] = System.DateTime.Today;
                tbGarantia.Rows.Add(row);
                (rlv_factura.InsertItem.FindControl("rg_pagos") as RadGrid).DataSource = tbGarantia;
        ...
        protected void rg_pagos_OnDeleteCommand(object source, GridCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                case "Delete":
                    ...
                    int pos = 0;
                    int xpos = 0;
                    foreach (DataRow row in tbGarantia.Rows)
                    {
                    ...
                    tbGarantia.Rows[pos].Delete();
                    tbGarantia.AcceptChanges();
                    foreach (DataRow row in tbGarantia.Rows)
                    {
                        row["PGNROITM"] = i;
                        i++;
        ...
        protected void obj_factura_OnInserting(object sender, ObjectDataSourceMethodEventArgs e)
        {
            ...
            e.InputParameters["tbPagos"] = tbGarantia;
        }
        ...
        protected void rg_items_OnDeleteCommand(object source, GridCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                case "Delete":
                    ...
                    tbGarantia.Rows.Clear();
                    ((source as RadGrid).Parent.FindControl("rg_pagos") as RadGrid).DataSource = tbGarantia;
        ...
        protected void btn_aceptar_facdev_OnClick(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                DataRow rp = tbGarantia.NewRow();
                rp["PGCODEMP"] = Convert.ToString(Session["CODEMP"]);
                rp["PGTIPFAC"] = "";
                rp["PGNROFAC"] = 0;
                rp["PGNROITM"] = tbGarantia.Rows.Count + 1;
                rp["PGTIPPAG"] = "05";
                rp["PGDETTPG"] = ".";
