...
{
    public partial class RemisionSegmento : System.Web.UI.Page
    {
        ...
        protected void btn_filtro_OnClick(object sender, EventArgs e)
        {
            ...
            //    filtro += " AND  LIKE '%" + (((RadButton)sender).Parent.FindControl("txt_apellidos") as RadTextBox).Text + "%'";
        ...
        protected void obj_factura_OnInserted(object sender, ObjectDataSourceStatusEventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    {
                        url = ComunBL.GetHttpHttps(HttpContext.Current.Request.Url.AbsoluteUri) + "//" + HttpContext.Current.Request.Url.Authority + "/Reportes/VisorPantallaCompleta.aspx?rpt=8008&inban=S&inImp=S&inClo=S&inParametro=InNumero&inValor=" + retorno[1] +
        ...
        protected void iBtnImprimir_OnClick(object sender, EventArgs e)
        {
            ...
            //    else
            //    {
            //        url = ComunBL.GetHttpHttps(HttpContext.Current.Request.Url.AbsoluteUri) + "//" + HttpContext.Current.Request.Url.Authority + "/Reportes/VisorPantallaCompleta.aspx?rpt=8008&inban=S&inParametro=InNumero&inValor=" + (rlv_factura.Items[0].FindControl("txt_nrofac") as RadTextBox).Text +
