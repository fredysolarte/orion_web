<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterAdmin.Master" AutoEventWireup="true" CodeBehind="FacturaDirecta.aspx.cs" Inherits="XUSS.WEB.Facturacion.FacturaDirecta" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <telerik:RadScriptBlock ID="rsbDownLoad" runat="server">
        <script type="text/javascript">            
            ...
            function rc_tpago_OnClientSelectedIndexChanged(sender, eventArgs) {
                ...
                document.getElementById("<%=btn_openbono.ClientID %>").style.display = 'none';
                if (item.get_value() == "11")
                    document.getElementById("<%=btn_openbono.ClientID %>").style.display = '';
    ...
    <telerik:RadAjaxPanel ID="RadAjaxPanel2" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
                            ...
                            <telerik:RadGrid ID="rg_items" runat="server" GridLines="None" Width="100%" AutoGenerateColumns="False" Height="100%" OnItemCommand="rg_items_OnItemCommand"
                                ...
                                <MasterTableView ShowGroupFooter="true">
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn DataField="DTPRELIS" HeaderButtonType="TextButton" HeaderStyle-Width="150px" DataType="System.Decimal"
                                        ...
                                        <telerik:GridBoundColumn DataField="DTPRECIO" HeaderButtonType="TextButton" HeaderStyle-Width="150px"
                                        ...
                                        <telerik:GridBoundColumn DataField="DTSUBTOT" HeaderButtonType="TextButton" HeaderStyle-Width="150px"
                                        ...
                                        <telerik:GridBoundColumn DataField="DTTOTIVA" HeaderButtonType="TextButton" HeaderStyle-Width="150px"
                                        ...
                                        <telerik:GridBoundColumn DataField="DTTOTFAC" HeaderButtonType="TextButton" HeaderStyle-Width="150px"
        ...
        <telerik:RadWindowManager RenderMode="Lightweight" ID="RadWindowManager1" runat="server" EnableShadow="true" Style="z-index: 7001;">
            ...
            <Windows>
                <telerik:RadWindow RenderMode="Lightweight" ID="modalPopup" runat="server" Width="900px" Height="350px" Modal="true" OffsetElementID="main" Title="Detalle" OnClientClose="modalPopup_OnClientClose" OnClientCommand="modalPopup_OnClientCommand" EnableShadow="true" Style="z-index: 100001;">
                    <ContentTemplate>
                        <table>
                            <tr>
                                <td>Cod Barras</td>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    ...
                                    <%----%>
                                    <asp:ImageButton ID="iBtnFindArticulo" runat="server" CommandName="Buscar" Text="Buscar" SkinID="SkinBuscarPQ" OnClick="iBtnFindArticulo_OnClick" Enabled="false" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <telerik:RadTextBox ID="txt_soporte" runat="server" Enabled="true" Visible="true" Width="300px">
                                        <%--OnTextChanged="txt_soporte_OnTextChanged" AutoPostBack="true"--%>
                                    </telerik:RadTextBox>
                                    <asp:ImageButton ID="btn_openbono" runat="server" CommandName="Buscar" Text="Buscar" SkinID="SkinBuscarPQ" Enabled="true" OnClick="btn_openbono_Click" />
                        ...
                        <table>
                            <tr>
                                <td>
                                    ...
                                    <telerik:RadButton RenderMode="Lightweight" ID="btn_aceptar_facdev" runat="server" Text="Agregar" Icon-PrimaryIconCssClass="rbAdd" OnClick="btn_aceptar_facdev_OnClick" CommandName="Cancel" />
                                </td>
                            </tr>
                        </table>
                    </ContentTemplate>
                    ...
                    <ContentTemplate>
                        <table>
                            <tr>
                                ...
                                <td>
                                    <asp:Button ID="btn_filtro_sep" runat="server" Text="Filtrar" OnClick="btn_filtro_sep_OnClick"
                                        CommandName="Cancel" />
                                </td>
                            </tr>
                        </table>
                        ...
                        <table>
                            <tr>
                                <td>
                                    ...
                                    <telerik:RadButton RenderMode="Lightweight" ID="btn_aceptar_sep" runat="server" Text="Agregar" Icon-PrimaryIconCssClass="rbAdd" OnClick="btn_aceptar_sep_OnClick" CommandName="Cancel" />
                                </td>
                            </tr>
                        </table>
                    </ContentTemplate>
                </telerik:RadWindow>
                <telerik:RadWindow RenderMode="Lightweight" ID="modalBono" runat="server" Width="650px" Height="560px" Modal="true" OffsetElementID="main" Style="z-index: 100001;" Title="Bonos">
                    <ContentTemplate>
                        <table>
                            <tr>
                                <td>
                                    <label>Nro Bono</label></td>
                                <td>
                                    <telerik:RadTextBox ID="txt_nrobono" runat="server" Enabled="true" Width="120px">
                                    </telerik:RadTextBox>
                                </td>
                                <td>
                                    <label>Nro Documento</label></td>
                                <td>
                                    <telerik:RadTextBox ID="txt_cedbono" runat="server" Enabled="true" Width="120px">
                                    </telerik:RadTextBox>
                                </td>
                                <td>
                                    <label>Cliente</label></td>
                                <td>
                                    <telerik:RadTextBox ID="txt_clibono" runat="server" Enabled="true" Width="120px">
                                    </telerik:RadTextBox>
                                </td>
                                <td>
                                    <asp:Button ID="btn_filtrobono" runat="server" Text="Filtrar" OnClick="btn_filtrobono_Click"
                                        CommandName="Cancel" />
                                </td>
                            </tr>
                        </table>
                        <telerik:RadGrid ID="rg_bonos" runat="server" GridLines="None" Width="100%" AutoGenerateColumns="False"
                            Culture="(Default)" CellSpacing="0" OnItemCommand="rg_bonos_OnItemCommand">
                            <ClientSettings>
                                <Scrolling AllowScroll="True" UseStaticHeaders="True"></Scrolling>
                            </ClientSettings>
                            <MasterTableView>
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn DataField="T_NROBONO" HeaderButtonType="TextButton" HeaderStyle-Width="60px"
                                        HeaderText="Nro Bono" ItemStyle-HorizontalAlign="Right" Resizable="true" SortExpression="T_NROBONO"
                                        UniqueName="T_NROBONO">
                                        <ItemStyle HorizontalAlign="Right" />
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn DataField="T_CODIGO" HeaderButtonType="TextButton" HeaderStyle-Width="80px"
                                        HeaderText="Codigo" ItemStyle-HorizontalAlign="Right" Resizable="true" SortExpression="T_CODIGO"
                                        UniqueName="T_CODIGO">
                                        <ItemStyle HorizontalAlign="Right" />
                                    </telerik:GridBoundColumn>
                                    <telerik:GridTemplateColumn DataField="T_SALDO" HeaderText="Dcto" HeaderStyle-Width="40px"
                                        Resizable="true" SortExpression="T_SALDO" UniqueName="T_SALDO" Visible="false">
                                        <ItemTemplate>
                                            <telerik:RadNumericTextBox ID="txt_valor" runat="server" Enabled="true" DbValue='<%# Bind("T_SALDO") %>'
                                    ...
                                    <telerik:GridBoundColumn DataField="T_SALDO" HeaderButtonType="TextButton" HeaderStyle-Width="100px"
                                        DataFormatString="{0:C}" HeaderText="Saldo Bono" ItemStyle-HorizontalAlign="Right" DataType="System.Double"
