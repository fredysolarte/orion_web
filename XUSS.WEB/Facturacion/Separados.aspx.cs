...
{
    public partial class Separados : System.Web.UI.Page
    {
        ...
        {
            string filtro = "AND HDTIPFAC IN (SELECT TFTIPFAC FROM TBTIPFAC WITH(NOLOCK) WHERE TFCLAFAC IN(3))";
