<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterAdmin.Master" AutoEventWireup="true" CodeBehind="Garantias.aspx.cs" Inherits="XUSS.WEB.Facturacion.Garantias" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <telerik:RadAjaxPanel ID="RadAjaxPanel2" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
                            ...
                            <td colspan="2">
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Label runat="server" ID="lbl_facdev" Visible="false">
                                                Fac Dev</asp:Label>
                                        </td>
                                        <td>
                                            <telerik:RadTextBox ID="txt_facdev" runat="server" Enabled="false" Text='<%# Bind("HDNRODEV") %>' Width="40px" Visible="false">
                                            </telerik:RadTextBox>
                                            <telerik:RadButton RenderMode="Lightweight" ID="btn_buscar_fac" OnClick="btn_buscar_fac_OnClick" runat="server" Icon-PrimaryIconCssClass="rbSearch" ToolTip="Buscar Factura" Visible="false" />
                                        </td>
                                        <td>
                                            <asp:Label runat="server" ID="lbl_tdev" Visible="false">
                                                T F. Dev</asp:Label>
                                        </td>
                                        <td>
                                            <telerik:RadComboBox ID="rc_facdev" runat="server" Culture="es-CO" Width="250px" Visible="false"
                                        ...
                                        <td>
                                            <asp:Label runat="server" ID="lbl_nrosep" Visible="false">
                                                Nro Sep</asp:Label>
                                        </td>
                                        <td>
                                            <telerik:RadTextBox ID="txt_separado" runat="server" Enabled="false" Width="40px" Visible="false">
                                            </telerik:RadTextBox>
                                            <telerik:RadButton RenderMode="Lightweight" ID="btn_buscar_sep" OnClick="btn_buscar_sep_OnClick" runat="server" Icon-PrimaryIconCssClass="rbSearch" ToolTip="Buscar Factura" Visible="false" />
                                        </td>
                                        <td>
                                            <asp:Label runat="server" ID="lbl_tsep" Visible="false">
                                                T. Sep</asp:Label>
                                        </td>
                                        <td>
                                            <telerik:RadComboBox ID="rc_separado" runat="server" Culture="es-CO" Width="250px"
                                                Enabled="false" DataSourceID="obj_separado" DataTextField="TFNOMBRE" Visible="false"
                                                DataValueField="TFTIPFAC" AppendDataBoundItems="true">
                                                <Items>
                                                    <telerik:RadComboBoxItem Text="Seleccionar" Value="" />
                                                </Items>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <telerik:RadComboBox ID="rc_lstprecio" runat="server" Culture="es-CO" Width="300px"
                                                            Enabled="false" DataSourceID="obj_lstprecio" DataTextField="P_CNOMBRE"
                    ...
                    <telerik:RadSplitter RenderMode="Lightweight" ID="RadSplitter1" runat="server" Width="100%" Height="380px">
                        ...
                        <telerik:RadPane ID="RadPane1" runat="server" Width="30%">
                            <telerik:RadGrid ID="rg_pagos" runat="server" GridLines="None" Width="100%" OnDeleteCommand="rg_pagos_OnDeleteCommand"
                                ...
                                <MasterTableView ShowGroupFooter="true" InsertItemDisplay="Top" CommandItemDisplay="Top" DataKeyNames="GT_CONSECUTIVO">
                                    <CommandItemSettings AddNewRecordText="Nueva Observacion" ShowRefreshButton="false" />
                                    <Columns>
                                        <telerik:GridBoundColumn DataField="GT_OBSERVACIONES" HeaderButtonType="TextButton" HeaderStyle-Width="80px"
                                            HeaderText="Seguimiento" ItemStyle-HorizontalAlign="Right" Resizable="true" SortExpression="GT_OBSERVACIONES"
                                            UniqueName="GT_OBSERVACIONES">
                                            <ItemStyle HorizontalAlign="Right" />
                                        </telerik:GridBoundColumn>
                                    </Columns>
                                    <NoRecordsTemplate>
        ...
        <telerik:RadWindowManager RenderMode="Lightweight" ID="RadWindowManager1" runat="server" EnableShadow="true" Style="z-index: 7001;">
            ...
            <Windows>
                ...
                <telerik:RadWindow RenderMode="Lightweight" ID="modalPagos" runat="server" Width="700px" Height="300px" Modal="true" OffsetElementID="main" Style="z-index: 100001;" Title="Seguimiento">
                    <ContentTemplate>
                        <table>
                            <tr>
                                <td>
                                    <telerik:RadTextBox ID="txt_observaciones" runat="server" Enabled="true"
                                        Width="600px" TextMode="MultiLine" Height="90px">
                                    </telerik:RadTextBox>
                ...
                <telerik:RadWindow RenderMode="Lightweight" ID="modalFactura" runat="server" Width="990px" Height="560px" Modal="true" OffsetElementID="main" Style="z-index: 100001;" Title="Detalle Facturas">
                    <ContentTemplate>
                        ...
                        <table>
                            <tr>
                                <td>
                                    <asp:Button ID="btn_aceptar_facdev" runat="server" Text="Agregar" OnClick="btn_aceptar_facdev_OnClick"
                                        CommandName="Cancel" Icon-PrimaryIconCssClass="rbAdd" />
                                </td>
                            </tr>
                        </table>
                    </ContentTemplate>
                ...
                <telerik:RadWindow RenderMode="Lightweight" ID="modalSeparado" runat="server" Width="990px" Height="560px" Modal="true" OffsetElementID="main" Style="z-index: 100001;" Title="Detalle Facturas">
                    <ContentTemplate>
                        ...
                        <table>
                            <tr>
                                <td>
                                    <asp:Button ID="btn_aceptar_sep" runat="server" Text="Agregar" OnClick="btn_aceptar_sep_OnClick"
                                        CommandName="Cancel" Icon-PrimaryIconCssClass="rbAdd" />
                                </td>
                            </tr>
                        </table>
    ...
    <asp:ObjectDataSource ID="obj_factura" runat="server" OldValuesParameterFormatString="original_{0}" InsertMethod="InsertGaratia" OnInserted="obj_factura_OnInserted"
        SelectMethod="GetFacturaHD" TypeName="XUSS.BLL.Facturacion.GarantiasBL" OnInserting="obj_factura_OnInserting">
        <SelectParameters>
    ...
    <asp:ObjectDataSource ID="obj_tfxusuario" runat="server" OldValuesParameterFormatString="original_{0}"
        ...
        <SelectParameters>
            <asp:Parameter Name="connection" Type="String" />
            <asp:Parameter DefaultValue="TFCLAFAC IN (6)" Name="filter" Type="String" />
