<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterAdmin.Master" AutoEventWireup="true" CodeBehind="DesmTotal.aspx.cs" Inherits="XUSS.WEB.Consultas.DesmTotal" %>
        ...
        <div>
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadComboBox ID="rc_dia" runat="server" AppendDataBoundItems="true">
                            <Items>
                    ...
                    <td>
                        <telerik:RadComboBox ID="rc_bodega" runat="server" Culture="es-ES" 
                            DataSourceID="obj_bodegas" DataTextField="BDNOMBRE" DataValueField="BDBODEGA" AppendDataBoundItems="true">
                            <Items>
                ...
                <MasterTableView ShowGroupFooter="true" CommandItemDisplay="Top">
                    ...
                    <Columns>                                                
                        ...
                        <%--<telerik:GridBoundColumn DataField="FAC_DIA" HeaderButtonType="TextButton" HeaderStyle-Width="300px" AllowSorting="true" ColumnGroupName="gFacturas"
                            DataFormatString="{0:N0}" HeaderText="FACT." ItemStyle-HorizontalAlign="Right"
                        ...
                        <telerik:GridBoundColumn DataField="FAC_ACU" HeaderButtonType="TextButton" HeaderStyle-Width="80px" AllowSorting="true" ColumnGroupName="gFacturas"
                            HeaderText="FACT. ACUM." ItemStyle-HorizontalAlign="Right" Resizable="true" DataFormatString="{0:N0}"
                            SortExpression="FAC_ACU">
                            <HeaderStyle Width="120px" Font-Size="9px"/>
                            <ItemStyle HorizontalAlign="Right" />
                        </telerik:GridBoundColumn>
                        <%--<telerik:GridBoundColumn DataField="TOTFAC_DIA" HeaderButtonType="TextButton" HeaderStyle-Width="80px" AllowSorting="true"
                            HeaderText="T. FAC DIA" ItemStyle-HorizontalAlign="Right" Resizable="true"
                            DataFormatString="{0:N0}" SortExpression="TOTFAC_DIA">
                            <HeaderStyle Width="150px" Font-Size="9px"/>
                            <ItemStyle HorizontalAlign="Right" />
                        </telerik:GridBoundColumn>--%>
                        <telerik:GridBoundColumn DataField="TOTFAC_ACU" HeaderButtonType="TextButton" HeaderStyle-Width="80px" AllowSorting="true"
                            HeaderText="T. FAC ACUM" ItemStyle-HorizontalAlign="Right" Resizable="true" Aggregate="Sum"
    ...
    <asp:ObjectDataSource ID="obj_consulta" runat="server" OldValuesParameterFormatString="original_{0}"
        ...
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="rc_bodega" DefaultValue="" Name="bodega" PropertyName="SelectedValue"
                Type="String" />
            <asp:ControlParameter ControlID="rc_dia" DefaultValue="" Name="dia" PropertyName="SelectedValue"
                Type="String" />
        </SelectParameters>
    </asp:ObjectDataSource>
